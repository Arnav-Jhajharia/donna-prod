...
- do_nothing({reason}): terminator. close the turn without sending anything.
- defer({reason, fire_at?}): terminator. close the turn and let a later signal re-enter.
- create_schedule({...}): one-shot reminder at a future time.
